...
| 方法 | 路径 | 说明 | 角色 |
|---|---|---|---|
| GET | `/api/auth/me` | 获取当前登录用户信息 | 已登录用户 |
...
| 方法 | 路径 | 说明 | 角色 | 关联表 |
|---|---|---|---|---|
| POST | `/api/patients` | 新增患者档案 | ADMIN / REGISTRATION_CLERK | `patient` |
| GET | `/api/patients/{id}` | 查询患者详情 | PATIENT / DOCTOR / ADMIN | `patient` |
| PUT | `/api/patients/{id}` | 修改患者信息 | PATIENT / ADMIN | `patient` |
| GET | `/api/patients` | 条件分页查询患者 | DOCTOR / ADMIN | `patient` |
...
| 方法 | 路径 | 说明 | 角色 | 关联表 |
|---|---|---|---|---|
| GET | `/api/departments` | 查询科室列表 | 全部 | `department` |
| GET | `/api/departments/tree` | 查询科室树 | 全部 | `department` |
| POST | `/api/departments` | 新增科室 | ADMIN | `department` |
| PUT | `/api/departments/{id}` | 修改科室 | ADMIN | `department` |
...
| 方法 | 路径 | 说明 | 角色 | 关联表 |
|---|---|---|---|---|
| GET | `/api/doctors` | 查询医生列表 | 全部 | `doctor` |
| GET | `/api/doctors/{id}` | 查询医生详情 | 全部 | `doctor` |
| POST | `/api/doctors` | 新增医生档案 | ADMIN | `doctor` |
| PUT | `/api/doctors/{id}` | 修改医生档案 | ADMIN | `doctor` |
...
| 方法 | 路径 | 说明 | 角色 | 关联表 |
|---|---|---|---|---|
| GET | `/api/schedules` | 分页查询排班 | 全部 | `doctor_schedule` |
| POST | `/api/schedules` | 新增排班 | ADMIN | `doctor_schedule` |
| PUT | `/api/schedules/{id}` | 修改排班 | ADMIN | `doctor_schedule` |
| POST | `/api/schedules/{id}/close` | 停诊 / 关闭号源 | ADMIN | `doctor_schedule` |
...
| 方法 | 路径 | 说明 | 角色 | 关联表 |
|---|---|---|---|---|
| GET | `/api/drugs` | 分页查询药品 | DOCTOR / PHARMACY / ADMIN | `drug_info` |
| GET | `/api/drugs/{id}` | 查询药品详情 | DOCTOR / PHARMACY / ADMIN | `drug_info` |
| POST | `/api/drugs` | 新增药品 | PHARMACY / ADMIN | `drug_info` |
| PUT | `/api/drugs/{id}` | 修改药品 | PHARMACY / ADMIN | `drug_info` |
| POST | `/api/drugs/{id}/stock-adjust` | 库存调整 | PHARMACY / ADMIN | `drug_info` |
